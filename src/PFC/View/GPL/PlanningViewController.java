...
public class PlanningViewController implements Initializable,ControlledScreen {
		...
		try {
			...
			for(Creneau c : listCreneau)
			{
				...
				final Examen examen = new Examen();
				 ...
				 ModuleDrop moduleDrop = new ModuleDrop();
				 ...
				 {					
					 //
					 final Surveiller survaillance = new Surveiller();
					 examen.getSurvaillances().add(survaillance);
				 ...
				 planning.getListExamen().add(examen);
	...
	{
		myController.setScreen(Main.gplCreateScreen);
